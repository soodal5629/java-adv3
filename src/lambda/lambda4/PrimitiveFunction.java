...
public class PrimitiveFunction {
    public static void main(String[] args) {
        ...
        System.out.println("function.apply(4) = " + function.apply(4));

        // 기본형 반환, ToIntFunction, ToLongFunction, ToDoubleFunction
        ToIntFunction<String> toIntFunction = s -> s.length();
        System.out.println("toIntFunction.applyAsInt(\"jcl\") = " + toIntFunction.applyAsInt("jcl"));

        // 기본형 매개변수, 기본형 반환
        IntToLongFunction intToLongFunction = x -> x * 100L;
        System.out.println("intToLongFunction.applyAsLong(500) = " + intToLongFunction.applyAsLong(500));
